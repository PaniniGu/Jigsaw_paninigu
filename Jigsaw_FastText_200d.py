...
def load_data(embed_path, train_path, test_path, maxlen=220, embed_size=200, max_features=100000):
...
def train(X_train, y_train, X_test, embedding_matrix, batch_size=2048, embed_size=200, max_features=100000, n_splits=5):
    ##############            Training                         
    ...
    for i, (train_idx, valid_idx) in enumerate(splits):
        ...
        model = FastText(embedding_matrix, max_features, embed_size)
        model.cuda()
